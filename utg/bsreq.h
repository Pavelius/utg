...
#define	BSDSN(nm, fn, TE) {#nm, FO(data_type, fn), sizeof(data_type::fn[0]), sizeof(data_type::fn), sizeof(data_type::fn)/sizeof(data_type::fn[0]), bsmeta<TE>::meta, KindDSet, bsdata<TE>::source_ptr}
